<template>
  <div class="m-16">
    <div class="border-yellow bg-yellow-light-4 flex w-full rounded-lg border-l-[6px] px-7 py-8 md:p-9">
      <div class="bg-yellow mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md">
